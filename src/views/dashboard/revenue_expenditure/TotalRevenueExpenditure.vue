        ...
        <vx-card title="Thu chi(tháng)">
            ...
            <div slot="no-body" class="p-6 pb-0">
                ...
                <div class="flex" v-if="last_month">
                    <div class="mr-6">
                        <p class="mb-1 font-semibold">Thu</p>
                        <p class="text-3xl text-success"><sup class="text-base mr-1">$</sup>10,589</p>
                    </div>
                    <div>
                        <p class="mb-1 font-semibold">Chi</p>
                        <p class="text-3xl"><sup class="text-base mr-1">$</sup>3,683</p>
                    </div>
                </div>
                <div class="flex" v-if="last_year">
                    <div class="mr-6">
                        <p class="mb-1 font-semibold">Thu</p>
                        <p class="text-3xl text-success"><sup class="text-base mr-1">$</sup>186,589</p>
                    </div>
                    <div>
                        <p class="mb-1 font-semibold">Chi</p>
                        <p class="text-3xl"><sup class="text-base mr-1">$</sup>93,683</p>
                    </div>
                </div>
               <div v-if="last_month">
