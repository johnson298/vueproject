...
<div id="data-list-list-view" class="data-list-container">
    <add-new-data-sidebar v-if="addNewDataSidebar" :isSidebarActive="addNewDataSidebar" @closeSidebar="addNewDataSidebar = false" :callback="getData" />

    <edit-course-sidebar v-if="editCourseSidebar" :isSidebarEditActive="editCourseSidebar" @closeSidebar="editCourseSidebar = false" :coursesGetInfo="coursesGetInfo" :getData="getData" />
    <vs-table-custom :sst="true" ref="table" multiple v-model="selected" @search="handleSearch" @sort="handleSort" :data="courses" search id="table" maxItems="10">
        ...
        <template slot-scope="{data}">
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data" class="col">
                ...
                <vs-td v-if="views.program.viewable">{{ tr.program.name }}</vs-td>
                ...
                <vs-td v-if="views.progress.viewable">
                    ...
                    <vs-progress :percent="tr.progress*100/tr.number_of_lessons" :color="(tr.progress*100/tr.number_of_lessons<100)?'primary':'success'"></vs-progress>
                </vs-td>
                <vs-td v-if="views.status.viewable">
                  <vs-chip :color="checkStatus(statusCourse,tr.status)==='Mở' ? 'warning'
                ...
                <vs-td v-if="views.action.viewable" class="d-flex-span">
                    ...
                    <vs-button radius color="primary" size="small" @click="detailCourse(tr)" class="vs-component vs-button vs-button-primary vs-button-filled includeIcon includeIconOnly small">
