        ...
        <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data" class="col">
          ...
          <vs-td v-if="views.action.viewable" class="d-flex-span">
            <router-link
              tag="button"
              :to="'/customers/'"
              class="vs-component vs-button vs-button-primary vs-button-filled includeIcon includeIconOnly small" title="Chi tiết khác hàng"><i class="feather icon-eye"></i></router-link>
