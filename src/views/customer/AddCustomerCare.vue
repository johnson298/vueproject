    ...
    <div>
        <div class="vs-row">
            <div class="vs-col w-full">
                <div class="mt-5 note"><label class="vs-input--label">Nội dung chăm sóc</label></div>
        ...
        <vs-col class="mt-5" vs-w='12' vs-type="flex" vs-justify="flex-end">
            ...
            <vs-button class="ml-3 vs-con-loading__container" type="filled" color="primary" @click="createInvoice" ref="addButton" id="btn-loading">Thêm chăm sóc</vs-button>
