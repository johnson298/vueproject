<template>
    <div id="data-list-list-view" class="data-list-container">
        ...
        <edit-sidebar :isSidebarEditActive="editSidebar" @closeSidebar="editSidebar = false" :roomGetInfo="roomGetInfo" :getData="getData" />

        <vs-table-custom :sst="true" ref="table" multiple v-model="selected" @search="handleSearch" @sort="handleSort" :data="rooms" search id="table" maxItems="10">
