    ...
    <div class="vx-row">
        <div class="vx-col md:w-1/2 w-full mb-base">
            ...
            <div class="mt-5">
                ...
                <datepicker :fullMonthName="true" v-model="formatDate" :language="languages[language]" format="d MMMM yyyy" :value="user.birthday" class="w-full picker-custom"></datepicker>
            </div>
            <div>
