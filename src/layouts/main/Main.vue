...
<div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
    ...
    <vx-sidebar :sidebarItems="sidebarItems" :logoSmall="require('@/assets/images/logo/logo-small.png')" :logo="require('@/assets/images/logo/logo.png')" title="" parent=".layout--main" />
